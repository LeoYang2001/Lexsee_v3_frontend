...
const BalancedGoal = ({
  ...
  const [customMasteryInterval, setCustomMasteryInterval] = useState("120");
  const [customNotificationsEnabled, setCustomNotificationsEnabled] =
    useState(false);
  const [customOverallGoal, setCustomOverallGoal] = useState("1200");
  ...
  const handleSelectingMilestone = (id: string) => () => {
    ...
    const selectedOption = balancedMilestoneOptions.find(
      (option) => option.id === id,
    );
    if (selectedOption) {
    ...
    <View className="flex-1 px-6 pt-8">
      ...
      <View className="mb-6">
        ...
        <View className="gap-3">
          {balancedMilestoneOptions.map((option) => (
            <TouchableOpacity
              key={option.id}
              ...
              <View className="mb-5">
                ...
                <View className="flex-row gap-2">
                  {[
                    ...
                    { days: 120, label: "Growth", recommended: true },
