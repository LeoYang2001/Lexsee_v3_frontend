        ...
        >
          ...
          >
            ...
            {!isMessageFocused && (
              ...
              >
                <TouchableOpacity
                  className="ml-auto mt-4 mb-2  p-2"
                ...
                <Text className="text-gray-400 text-md mb-12">
                  Your feedback is important to us, please leave us a message
                  and we will email you back as soon as possible.
                </Text>
                ...
                <View className="flex-row mb-8 gap-2">
                  {categories.map((item) => (
                    ...
                    >
                      <Text
                        className={`capitalize ${formData.category === item ? "text-white" : "text-gray-400"}`}
                      >
                        {item}
                      </Text>
                    </TouchableOpacity>
